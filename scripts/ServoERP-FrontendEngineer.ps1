...
$batches = @(
    ...
    @{ Page = 'Suppliers'; Screen = 'Supplier dashboard, detail, duplicate merge dialog'; Issue = 'Supplier screens require recurring terminology, duplicate flow, badge, and form audit.'; Fix = 'Run Codex audit prompt, inspect VendorForm, and apply scoped fixes before this build.' },
